		...
		<div class="row justify-content-center">
	        ...
	        <div class="col-md-12">
				    ...
				    <form>
				        <div class="row">
				          <div class="col-md-6">
				            <fg-input type="text"
				                     ...
				                     >
				            <small class="text-danger" v-if='errors.nombre'>
                                  <ul>
				          ...
				          <div class="col-md-6">
				            <fg-input type="text"
                                  ...
                                  :inputclass="{ 'is-invalid': isActive.apellido}"
				                     >
				            <small class="text-danger" v-if='errors.apellido'>
                                  <ul>
				          ...
				          <div class="col-2">
				           ...
				           <div class="col-md-4">
				            <fg-input type="number"
				                     ...
				                     >
				            <small class="text-danger" v-if='errors.cedula'>
                                  <ul>
                                    <li v-for="error in errors.cedula">{{error}}</li>
                                  </ul>
                                </small>
				            </fg-input>
				          </div>
				        ...
				        <small class="text-danger" v-if='errors.fechanacimiento'>
                                  <ul>
                                    <li v-for="error in errors.fechanacimiento">{{error}}</li>
                                  </ul>
                                </small>
				          </div>
				        ...
				        <div class="row">
				  		 <div class="col-md-6 col-lg-4">
				            <label for="genero">Genero * </label>
							    ...
							    <small class="text-danger" v-if='errors.genero'>
                                  <ul>
                                    <li v-for="error in errors.genero">{{error}}</li>
                                  </ul>
                                </small>
				          </div>
				          <div class="col-md-6 col-lg-4">
  ...
  created(){
	...
	methods: {
		...
		registroNatural: function(e){
             axios.post(API_ENDPOINT + 'auth/registro-natural',
              {
