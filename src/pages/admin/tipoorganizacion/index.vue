    ...
    <div class="container">
        <div class="row"> 
            <div class="col-12 text-center text-md-right">
               <a @click="create()" class="btn btn-primary text-white text-white">Registrar Nueva Organizacion</a>
            </div>      
            <div class="col-12">
              <h2 class="text-center">Listado de organizaciones </h2>
            </div>
<modal 
                       ref="close"
                          name="modalcreate"
                        ...
                        <div class="example-modal-content">
                          ...
                          <h2 class="text-center col-12">Registrar organizaciones </h2>
                              </div>
                          </div>
                          <organizacion-create></organizacion-create>
                      ...
                      <a class="text-danger" v-on:click="deletes(row.id)"><i class="fa fa-trash"></i></a>
                       ...
                       ref="close"
                        ...
                        <div class="example-modal-content">
                          ...
                          <h2 class="text-center col-12">Editar organizaciones </h2>
                              </div>
                          </div>
                          <organizacion-edit :data="row"></organizacion-edit>   
                        </div>
                      </modal>
                      <modal 
...
<script>
  ...
  import axios from "axios";
   ...
   import OrganizacionEdit from '@/pages/admin/tipoorganizacion/edit.vue';
   import OrganizacionShow from '@/pages/admin/tipoorganizacion/show.vue';
   import OrganizacionCreate from '@/pages/admin/tipoorganizacion/create.vue';
               ...
               modalOpen: false,
                ...
                options: {
                    ...
                    requestFunction: function (data) {
                        console.log(data);
                        return axios.get(API_ENDPOINT +'tipoorganizaciones/', { params: data }).catch(function (e) {
 ...
 methods: {   
   created: function() {
    ...
    deletes (id) {   
      axios.delete(API_ENDPOINT + 'tipoorganizaciones' + '/'+id,{
      	'id':id,
      },{
         headers: {
